  ...
  return (
    <div id={RESOURCE.plural}>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>{isLoading ? <Spinner animation="border" size="sm" variant="primary" className="align-self-center" /> : attributes?.title}</Breadcrumb.Item>
      </Breadcrumb>
      <h2>Film: {isLoading ? <Spinner animation="border" size="sm" variant="primary" className="align-self-center" /> : attributes?.title}</h2>
